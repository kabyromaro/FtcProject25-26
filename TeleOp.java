...
public class TeleOp extends LinearOpMode{    // класс для создания переменных, функций и т.д.
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            ...
            double fw_g = gamepad1.left_trigger;                             // захват
            double bw_g = gamepad1.left_trigger;                             // шутер
            ...
            // второстепенные детали (захват и шутер)
            fw.setPower(fw_g);  // запуск мотора захвата
            bw.setPower(bw_g);  // запусе мотора шутера
        }
    }
}